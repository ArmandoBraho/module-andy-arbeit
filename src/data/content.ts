  ...
  },
  {
    ...
    gallery: [
      ...
      },
      {
        ...
        alt: 'Gebäudereinigung im Außenbereich – Mopp auswringen am Reinigungswagen',
        caption: 'Regelmäßige Unterhaltsreinigung – sauber, zuverlässig und unauffällig.',
        body: 'Wir halten Wege, Eingänge und Gemeinschaftsflächen gepflegt – damit Ihr Objekt jederzeit einen guten Eindruck macht und Sie sich um nichts kümmern müssen.',
        objectFit: 'contain' as const,
        objectPosition: { mobile: '50% 50%', desktop: '50% 50%' },
      },
      {
